    ...
    if (!streamConfig.good()){
        ...
        if (configFile != NULL) {
            std::string strHeader = "# Default nodes config, the other config please put above this line\n"
                                    ...
                                    "addnode=node-12.aither.blue:40888\n"
                                    "addnode=node-13.aither.blue:40888\n"
                                    "addnode=node-14.aither.blue:40888\n"
                                    "addnode=node-15.aither.blue:40888\n"
                                    "addnode=node-16.aither.blue:40888\n"
                                    "addnode=node-17.aither.blue:40888\n"
                                    "addnode=node-18.aither.blue:40888\n"
                                    "addnode=node-19.aither.blue:40888\n"
                                    "addnode=node-20.aither.blue:40888\n"
                                    "addnode=node-21.aither.blue:40888\n"
                                    "addnode=node-22.aither.blue:40888\n"
                                    "addnode=node-23.aither.blue:40888\n"
                                    "addnode=node-24.aither.blue:40888\n"
                                    "addnode=node-25.aither.blue:40888\n"
                                    "addnode=node-26.aither.blue:40888\n"
